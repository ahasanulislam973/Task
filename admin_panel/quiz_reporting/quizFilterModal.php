    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" id="submit_form" method="post" autocomplete="off">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                        <a href="quiz_log.php" <span class="btn btn-danger btn-block btn-sm"> Clear Filter</span>
                        </a>
                    </div>
                    <div class="clearfix"></div>
                </form>
...
<script type="text/javascript">
    ...
    var url = '<?php echo $quizCategoryNameUrl . "?organization_id=" . $_SESSION['admin_login_info']['organization_id'] ."&purpose=quiz_report";?>';
