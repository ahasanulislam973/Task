...
$jagofm_winner_list_export = $baseUrl . "export_data/dainik_shikha_winner_list_export.php";//newly added
...
$ntvwinnerList= $baseUrl . "reporting/dainik_shiksha_winner_list.php";
...
?>
    ...
    <script type="text/javascript">
        ...
        function getQuizContent(sel) {
            ...
            //  alert('quizid=' + x);
            <?php  $uri = PROJECT_BASE_PATH . "/quiz_reporting/winnerlist_dainik_shiksha.php?quiz_id=";?>
