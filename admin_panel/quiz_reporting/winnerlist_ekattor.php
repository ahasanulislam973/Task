...
$ntv_winner_list_export = $baseUrl . "export_data/ekattor_winner_list_export.php";//newly added
...
$subTabActive = "winnerlist_ekattor";
...
$ntvwinnerList= $baseUrl . "reporting/ekattor_winner_list.php";
...
?>
    ...
    <script type="text/javascript">
        ...
        function getQuizContent(sel) {
            ...
            //  alert('quizid=' + x);
            <?php  $uri = PROJECT_BASE_PATH . "/quiz_reporting/winnerlist_ekattor.php?quiz_id=";?>
        ...
        $('#btnDiv').on('click', '#export_data', function () {
            ...
            var base_url = '<?php echo $ntv_winner_list_export;?>';
