...
$ntv_winner_list_export = $baseUrl . "export_data/ntv_winner_list_export.php";//newly added
...
$ntvwinnerList= $baseUrl . "reporting/ntv_winner_list.php";
...
?>
    ...
    <script type="text/javascript">
        ...
        function getQuizContent(sel) {
            ...
            //  alert('quizid=' + x);
            <?php  $uri = PROJECT_BASE_PATH . "/quiz_reporting/winnelist_ntv.php?quiz_id=";?>
