                                        ...
                                        <form>
                                            ...
                                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <label class="control-label ">
                                                    Set Date Range <span  style="color:red">*</span></label>

                                                <input class="form-control" type="text" name="daterange" autocomplete="off" />
                                            </div>

                                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <label for="question_id">Messenger ID <span  style="color:red">*</span></label>
                                ...
                                <tbody>
                                    <?php if (!empty($quizLog)) { ?>
                                        ...
                                        foreach ($quizLog as $key => $row) {
                                            ...
                                            $is_sent = !empty($row->is_sent) ? $row->is_sent : "0";
                                        ?>
                                            <tr class="gradeX">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#my_dynamic_table').dataTable({
            ...
            var base_url = '<?php echo $UserQueryExprtUrl ;?>';
