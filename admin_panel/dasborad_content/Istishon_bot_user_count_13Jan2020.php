                ...
                <div class="col-md-4">
                    ...
                    <div class="value">
                        <div class="row multi-col">
                            ...
                            <div class="col-md-6">
                                <h6>Total User</h6>
                                <h4><?php echo number_format($TodayDailyNewsTotalUser, 0); ?></h4>
                    ...
                    <div class="value">
                        <div class="row multi-col">
                            ...
                            <div class="col-md-6">
                                ...
                                <h4><?php echo number_format($TodayHoroscopeTotalUser, 0); ?></h4>
                                <h6>Subscribed Today</h6>
                    ...
                    <div class="value">
                        <div class="row multi-col">
                            ...
                            <div class="col-md-6">
                                ...
                                <h4><?php echo number_format($TodayWordOfTheDayTotalUser, 0); ?></h4>
                                <h6>Subscribed Today</h6>
                    ...
                    <div class="value">
                        <div class="row multi-col">
                            ...
                            <div class="col-md-6">
                                ...
                                <h4><?php echo number_format($TodayLoveQuotesTotalUser, 0); ?></h4>
                                <h6>Subscribed Today</h6>
                    ...
                    <div class="value">
                        <div class="row multi-col">
                            ...
                            <div class="col-md-6">
                                ...
                                <h4><?php echo number_format($TodayTazaKhoborTotalUser, 0); ?></h4>
                                <h6>Subscribed Today</h6>
                    ...
                    <div class="value">
                        <div class="row multi-col">
                            ...
                            <div class="col-md-6">
                                ...
                                <h4><?php echo number_format($TodayRelationshipTipsTotalUser, 0); ?></h4>
                                <h6>Subscribed Today</h6>
