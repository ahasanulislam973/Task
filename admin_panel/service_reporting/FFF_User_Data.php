...
$pageTitle = "FFF Subscription History";
$tabActive = "service_reporting";
$subTabActive = "User History";
...
$fff_user_history = json_decode(file_get_contents($fff_user_history . $condition));
                            ...
                            <div class="adv-table">
                                <table class="display table table-bordered dataTable" id="my_dynamic_table">
                                    ...
                                    <tr class="">
                                        ...
                                        <th width="10%">fb_name</th>
                                        <th width="10%">msisdn</th>
                                        <th width="10%">attend_tournament</th>
                                        <th width="10%">buy_diamond</th>
                                        <th width="10%">gameplay_stream</th>
                                    ...
                                    <tbody>
                                    <?php if (!empty($fff_user_history)) { ?>
                                        <?php $sl = 0;
                                        foreach ($fff_user_history as $key => $row) {

                                            $MESSENGER_ID = !empty($row->MESSENGER_ID) ? $row->MESSENGER_ID : "";
                                            $fb_name = !empty($row->fb_name) ? $row->fb_name : "";
                                            $msisdn = !empty($row->msisdn) ? $row->msisdn : "";
                                            $attend_tournament = !empty($row->attend_tournament) ? $row->attend_tournament : "";
                                            $buy_diamond = !empty($row->buy_diamond) ? $row->buy_diamond : "";
                                            $gameplay_stream = !empty($row->gameplay_stream) ? $row->gameplay_stream : "";
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td>
                                                    <?php echo $attend_tournament; ?>
                                                </td>
                                                <td>
                                                    <?php echo $buy_diamond; ?>
                                                </td>
                                                <td>
                                                    <?php echo $gameplay_stream; ?>
                                                </td>
                                                <td>
                                                    <?php echo $status; ?>
                                                </td>
        ...
        $(document).ready(function () {
            ...
            $('#btnDiv').on('click', '#export_data', function () {
             ...
             //   var base_url = 'https://' + window.location.host + '/BOT/export_data/';
                var base_url = '<?php echo $fff_user_history_exprt;?>';
