...
$quizLog = json_decode(file_get_contents($votingsummeryUrl . $condition));
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnDiv').on('click', '#export_data', function () {
                ...
                var base_url = '<?php echo $votingSummaryExprtUrl ;?>';

                var first_date = $("#first_date").val();
                var last_date = $("#last_date").val();
                var quiz_id = '<?php if (isset($_REQUEST['quiz_id'])) echo $_REQUEST['quiz_id']; else echo $quiz_id;?>';
                var quiz_category_id = '<?php if (isset($_REQUEST['quiz_category_id'])) echo $_REQUEST['quiz_category_id'];else echo $quiz_category_id; ?>';
