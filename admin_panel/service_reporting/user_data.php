...
$apiHitUrl = $UserDataServerSideUrl . $condition;
            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="user_data.php">
                                            ...
                                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input id="startDate" autocomplete="off" placeholder="Start Date" class="form-control" type="text" />
                                                <input id="endDate" autocomplete="off" class="form-control" placeholder="End Date" type="text" />
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                <a href="user_data.php" <span class="btn btn-danger btn-block btn-sm"> Clear Filter</span>
                                                </a>
                                            </div>
                                            <div class="clearfix"></div>
                                        </form>
                        ...
                        <div class="adv-table">
                            <table class="display table table-bordered table-responsive dataTable" id="getStartedUser">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btnDiv').on('click', '#export_data', function() {
            ...
            var base_url = '<?php echo $userDataExportUrl; ?>';
