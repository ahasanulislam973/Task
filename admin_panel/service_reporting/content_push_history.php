...
$pageTitle = "Content Push History";
$tabActive = "service_reporting";
$subTabActive = "content_push_history";
...
$contentPushHistory = json_decode(file_get_contents($contentPushHistoryUrl . "$condition"));
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="content_push_history.php">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                    <a href="content_push_history.php" <span
        ...
        $(document).ready(function () {
            ...
            $('#btnDiv').on('click', '#export_data', function () {
             ...
             //   var base_url = 'https://' + window.location.host + '/BOT/export_data/';
                var base_url = '<?php echo $serviceContentPushExprtUrl;?>';
