                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                ...
                                <select name="user_report" id="user_report" class="form-control smart_select ">
                                    ...
                                    <option value="Himalayan_Quiz_Log">Himalayan Quiz Log</option>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnDiv').on('click', '#export_data_send_mail', function () {
                ...
                if (user_report == 'Himalayan_Quiz_Log') {
                    mailSubject = 'Himalayan Quiz Log';
                    var base_url = '<?php echo $quizLogExprtAndSendMail; ?>';
                    var quiz_id = '<?php if (isset($_REQUEST['quiz_id'])) echo $_REQUEST['quiz_id']; else echo $himalayanTimesQuizId;?>';
                    //window.open(base_url + '?first_date=' + first_date + "&last_date=" + last_date + '&messenger_id=' + messenger_id + '&back_url=' + '<?= $currentUrl; ?>' + '&mail_subject=' + '<?= $mailSubject; ?>' + "&quiz_id=" + quiz_id + "&msisdn=" + msisdn);
                    window.open(base_url + '?first_date=' + first_date + "&last_date=" + last_date  + '&back_url=' + '<?= $currentUrl; ?>' + '&mail_subject=' + mailSubject + "&quiz_id=" + quiz_id );
                }
                ...
                if (user_report == 'all') {
                    ...
                    //window.open(base_url + '?first_date=' + first_date + "&last_date=" + last_date + '&messenger_id=' + messenger_id + '&back_url=' + '<?= $currentUrl; ?>' + '&mail_subject=' + '<?= $mailSubject; ?>' + "&quiz_id=" + quiz_id + "&msisdn=" + msisdn);
                    window.open(base_url + '?first_date=' + first_date + "&last_date=" + last_date + '&messenger_id=' + messenger_id + '&back_url=' + '<?= $currentUrl; ?>' + '&mail_subject=' + mailSubject + "&msisdn=" + msisdn + '&page_id=' + '<?= $pageId; ?>' + '&sourceNode=' + sourceNode);
                }
