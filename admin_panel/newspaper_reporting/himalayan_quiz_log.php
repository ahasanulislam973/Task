...
$pageTitle = "Himalayan Quiz Log";
$tabActive = "newspaper_reporting";
$subTabActive = "himalayan_quiz_log";
$condition = '';
$_SESSION['successMsg'] = '';
//$serviceSelected = false;

$himalayanQuizId = $himalayanTimesQuizId;
$himalayanCategoryId = $himalayanTimesQuizCategoryId;

//$quizName = json_decode(file_get_contents($quizNameList . "?quiz_category_id=1"));

$qId = isset($himalayanQuizId) ? $himalayanQuizId : $_REQUEST['quiz_id'];
$condition = "?abc=abc&quiz_id=$qId";
                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <?php include 'himalayanQuizLogFilterModal.php'; ?>
                                    ...
                                    <?php if (!empty($quizLog)) { ?>
                                        ...
                                        foreach ($quizLog as $key => $row) {
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <!--<td><?php /*echo $quizCategoryName; */ ?></td>-->
                                                <!--<td><?php /*echo $quizId; */ ?></td>-->
                                                <!--<td><?php /*echo $quizTitle; */ ?></td>-->

                                                <td>
                                                    <?php echo $msisdn; ?>
                                                    <?php //echo $msisdn . '_' . $questionId; ?>
                                                </td>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnDiv').on('click', '#export_data', function () {
                ...
                var quiz_id = '<?php echo (isset($_REQUEST['quiz_id'])) ? $_REQUEST['quiz_id'] : $himalayanQuizId; ?>';
