...
$notificationSummary = json_decode(file_get_contents($notificationSummaryUrl_Istishon . $condition), false);
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="#">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                    <a href="notification_summary_lib_istishon.php" <span
                                ...
                                <table class="display table table-bordered dataTable" id="my_dynamic_table">
                                    ...
                                    if (!empty($notificationSummary)) {
                                        ...
                                        foreach ($notificationSummary as $key => $row) {
                                            ...
                                            $msisdn = !empty($row->MESSENGER_ID) ? $row->MESSENGER_ID : "";
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnDiv').on('click', '#export_data', function () {
                ...
                var base_url = '<?php echo $notificationSummaryExprtUrl_Istishon;?>';
