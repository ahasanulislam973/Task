...
if (isset($_SESSION['admin_login_info']) && $_SESSION['admin_login_info']['organization_id'] <> 4) { // only for himalayan times
    header('Location: ' . $accessDeniedPage);
    exit;
}
                                    ...
                                    <form accept-charset="utf-8" id="upload_content_form"
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <label class="label_check c_off">
                                                ...
                                                <input type="checkbox" name="has_multi" id="has_multi" value="yes"
                                                       onclick="showCheckbox()"> Add Multimedia Content<br>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('click', '#save_data', function (event) {
                ...
                $.ajax({
                    url: "../../bot_service_api/fileUploaderSendNotification.php?subscriber_type=Manual&services=Himalayan_Times&msg_type=English",
                    method: "POST",
                    data: form_data,
