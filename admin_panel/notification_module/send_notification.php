                                    ...
                                    <form accept-charset="utf-8" id="upload_content_form"
                                       ...
                                       <label class="label_check c_off">
                                        ...
                                        <div id="check_box" class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <label id="lblAudio" name="lblAudio" >Audio File(Max <?= $max_audio_size_mb; ?> MB)</label><input type="file"  name="audioFile" id="audioFile"  />
                                            <label id="lblVideo" name="lblVideo" >Video File(Max <?= $max_video_size_mb; ?> MB)</label><input type="file"  name="videoFile" id="videoFile"  />
                                        </div>
