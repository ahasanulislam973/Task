                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h2 class="modal-title">Content Upload Templates</h2>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <a href="/bot_service_api/upload_templates/quiz_template.xlsx">
                                                    <h4 class="control-label "><img src="../assets/img/xls-file.png"
                                                                                    width="10%" height="5%"/>
                                                        Quiz Template </h4></a>
                                            </div>
                                            ...
                                            <?php if ($organizationId == 3) { ?>
                                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <a href="/bot_service_api/upload_templates/telenor_content_template.xlsx">
                                                        <h4><img src="../assets/img/xls-file.png" width="10%"
                                                                 height="5%"/>
                                                            Telenor Content Template</h4>
                                                    </a>
                                                </div>
                                            <?php } ?>
